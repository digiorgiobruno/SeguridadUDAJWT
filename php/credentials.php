...
} catch (UnexpectedValueException $ee) {
    $mensaje = $ee->getMessage();
    echo $mensaje;
    die;
} catch (DomainException $de) {
    $mensaje = $de->getMessage();
    echo $mensaje;
    die;
} catch (Exception $e) {
...
$sqltok = MySQLDB::getInstance()->query("SELECT * FROM users WHERE id='$id' and name='$nombre'");
if ($sqltok->num_rows == 0) {
