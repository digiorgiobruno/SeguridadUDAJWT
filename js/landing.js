...
$('#register_button').click(() => {
    ...
    let legajo = $("#input-select-reg option:selected").val(); //estará determinado por la opción seleccionada
    let pass = $('#passR').val();
        ...
        $.ajax({
            ...
            success: function (rs) {
                ...
                if (rs == 1) {
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: '¡Revise su casilla de correos, no deseados o spam!'
                    });
